...
%
\newenvironment{astlisting}{\begin{list}{}{\setlength{\leftmargin}{1em}}\item\scriptsize\bfseries}
{\end{list}} 
...
\title{Asterisk Reference Information \\Version 1.6.2.0-beta3}
